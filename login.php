...
<html lang="en">
    ...
    <?php 
        ...
        if(!empty($_POST["submit"])){
            ...
            $query = UserModel::select_where(UserModel::$username_feild." = '$user' AND ".UserModel::$pass_feild." = '$pass'");

            $response = $userHandler->select_data($query);
            if(count($response) > 0){
...
<body>
    ...
    <div class="container-sm p-5 w-25">
        <form action="login.php" method="post">
            ...
            <button type="submit" name="submit" value="submit" class="btn btn-primary btn-block w-100">Login</button>
